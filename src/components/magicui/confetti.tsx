...
/* Verbatim from Magic UI's registry (magicui.design/r/confetti.json),
   minus ConfettiButton — it wraps shadcn/ui's <Button>, which this project
   doesn't have installed, and nothing here needs a confetti-on-click button;
   we trigger Confetti's fire() imperatively on signup success instead. */
